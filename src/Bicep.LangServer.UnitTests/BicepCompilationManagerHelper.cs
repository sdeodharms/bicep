...
namespace Bicep.LangServer.UnitTests
{
    public class BicepCompilationManagerHelper
    {
        ...
        {
            return new BicepCompilationProvider(TestTypeHelper.CreateEmptyProvider(), FileResolver, new ModuleDispatcher(BicepTestConstants.RegistryProvider), new ApiVersionProvider());
        }
